<?php 
    ...
    $query = "SELECT id, combo, gia, img_combo, mid, GROUP_CONCAT(ten) as mon_an FROM combo INNER JOIN ( SELECT id as mid, ten, combo_id FROM monan, combo_monan WHERE monan.id = monan_id ) as M ON M.combo_id = combo.id GROUP BY id";
        ...
        <div class="channel">
            ...
            <div class="part">
                ...
                <div class="part">
                    ...
                    <a href="main_monan.php" style="color: black;">Thực đơn</a>
                    |
                    <a href="#" style="color: black;">Combo cuối tuấn</a>
                        ...
                        ?>
                            ...
                            <div class="col-2 p">
                                <div class="card scaleOnHover">
                                    <div class="img">           
                                            <img class="img-channel"  src="./img/<?php echo $hang['img_combo'] ?>">
                                    </div>
                                    <div class="body-menu">
