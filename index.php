...
<body>
            ...
            <nav class="nav bd-container">
                ...
                <div class="nav__menu" id="nav-menu">
                    <ul class="nav__list">
                        ...
                        <li class="nav__item"><a href="#menu" class="nav__link nav__link-menu">Menu</a></li>
                        <!-- <li class="nav__item"><a href="#contact" class="nav__link">Contact us</a></li> -->
                        <li class="nav__item"><a href="main_monan.php" class="nav__link">Đặt đồ ăn</a></li>
                        <li class="nav__item ">
                            <!-- <img src="https://scontent.fhan2-2.fna.fbcdn.net/v/t1.6435-1/c12.0.100.100a/p100x100/116168776_2776638869224147_6993720188792426876_n.jpg?_nc_cat=110&ccb=1-5&_nc_sid=7206a8&_nc_ohc=lMR7TKIA5XsAX-f4rVP&_nc_ad=z-m&_nc_cid=0&_nc_ht=scontent.fhan2-2.fna&oh=00_AT_fAHgXejHRw9CfVeG88vgfmqpSQbsKn-3ahKArTBQzNA&oe=61DD3022" alt="" class="header__navbar-user-img"> -->
                            <span class="header__navbar-user-name">Hữu Thắng</span>
        ...
        <main class="l-main">
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        <h1 class="home__title">Delicious Food</h1>
                        <h2 class="home__subtitle">Hãy thử những món ăn ngon nhất trong tuần.</h2>
                        <a href="#" class="button">Xem Menu</a>
                    </div>
            ...
            <section class="about section bd-container" id="about">
                <div class="about__container  bd-grid">
                    <div class="about__data">
                        ...
                        <h2 class="section-title about__initial">Chúng tôi nấu những <br> món ăn ngon nhất</h2>
                        <p class="about__description">Chúng tôi nấu những món ăn ngon nhất trong toàn thành phố, với dịch vụ khách hàng tuyệt vời, những bữa ăn ngon nhất và giá tốt nhất, hãy ghé thăm chúng tôi.</p>
                        <a href="#" class="button">Khám phá lịch sử</a>
                    </div>
            ...
            <section class="services section bd-container" id="services">
                ...
                <h2 class="section-title">Dịch vụ tuyệt vời của chúng tôi</h2>
                ...
                <div class="services__container  bd-grid">
                    <div class="services__content">
                        ...
                        <h3 class="services__title">Thức ăn tuyệt vời</h3>
                        <p class="services__description">Chúng tôi mang đến cho khách hàng những dịch vụ chất lượng tuyệt vời trong nhiều năm, với những món ăn ngon và tốt nhất trong thành phố.</p>
                    </div>
                    ...
                    <div class="services__content">
                        ...
                        <h3 class="services__title">Thức ăn nhanh</h3>
                        <p class="services__description">Chúng tôi mang đến cho khách hàng những dịch vụ chất lượng tuyệt vời trong nhiều năm, với những món ăn ngon và tốt nhất trong thành phố.</p>
                    </div>
                    ...
                    <div class="services__content">
                        ...
                        <h3 class="services__title">Vận chuyển</h3>
                        <p class="services__description">Chúng tôi mang đến cho khách hàng những dịch vụ chất lượng tuyệt vời trong nhiều năm, với những món ăn ngon và tốt nhất trong thành phố.</p>
                    </div>
                </div>
            </section>
            ...
            <section class="menu section bd-container" id="menu">
                <span class="section-subtitle">Đặc biệt</span>
                <h2 class="section-title">Thực đơn trong tuần</h2>

                <div class="menu__container bd-grid">
                    <div class="menu__content">
                        <img src="assets/img/plate1.png" alt="" class="menu__img">
                        <h3 class="menu__name">Salad thịt nướng</h3>
                        <span class="menu__detail">Món ăn ngon</span>
                        <span class="menu__preci">200.000đ</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>

                    <div class="menu__content">
                        <img src="assets/img/plate2.png" alt="" class="menu__img">
                        <h3 class="menu__name">Salad với cá</h3>
                        <span class="menu__detail">Món ăn ngon</span>
                        <span class="menu__preci">300.000đ</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>
                    
                    <div class="menu__content">
                        <img src="assets/img/plate3.png" alt="" class="menu__img">
                        <h3 class="menu__name">Rau chân vịt trộn</h3>
                        <span class="menu__detail">Món ăn ngon</span>
                        <span class="menu__preci">100.000đ</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>

                    <div class="menu__content">
                        <img src="assets/img/plate4.png" alt="" class="menu__img">
                        <h3 class="menu__name">Cơm rang củ quả</h3>
                        <span class="menu__detail">Món ăn ngon</span>
                        <span class="menu__preci">80.000đ</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>

                    <div class="menu__content">
                        <img src="assets/img/plate5.png" alt="" class="menu__img">
                        <h3 class="menu__name">Salad cá hồi</h3>
                        <span class="menu__detail">Món ăn ngon</span>
                        <span class="menu__preci">350.000đ</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>

                    <div class="menu__content">
                        <img src="assets/img/plate6.png" alt="" class="menu__img">
                        <h3 class="menu__name">Hàu xào khế</h3>
                        <span class="menu__detail">Món ăn ngon</span>
                        <span class="menu__preci">200.000đ</span>
                        <a href="#" class="button menu__button"><i class='bx bx-cart-alt'></i></a>
                    </div>
                </div>
                <div style="margin-top: 40px; margin-left: 46%;" class="button__more">
                    <a href="main_monan.php">
                        <input style="background-color: var(--first-color); border-radius: 5px; height: 27px;" type="submit" value="Xem thêm" />
                    </a>
            ...
            <section class="app section bd-container">
                <div class="app__container bd-grid">
                    <div class="app__data">
                        ...
                        <p class="app__description">Tìm ứng dụng của chúng tôi và tải xuống, bạn có thể đặt chỗ, đặt đồ ăn, xem giao hàng của bạn trên đường đi và hơn thế nữa.</p>
                    ...
                    <img src="assets/img/movil-new-app.png" alt="" class="app__img">
                </div>
            </section>
            ...
            <section class="contact section bd-container" id="contact">
                <div class="contact__container bd-grid">
                    <div class="contact__data">
                        ...
                        <h2 class="section-title contact__initial">Liên hệ với chúng tôi qua Facebook</h2>
                        <p class="contact__description">
                            Nếu bạn muốn đặt bàn tại nhà hàng của chúng tôi, hãy liên hệ với chúng tôi và chúng tôi sẽ có mặt nhanh chóng với dịch vụ trò chuyện 24/7 của chúng tôi.</p>
                    </div>

                    <div class="contact__button">
                        <a href="https://www.facebook.com/thang.dz.227" class="button">Liên hệ ngay</a>
                    </div>
                </div>
            </section>
        </main>
